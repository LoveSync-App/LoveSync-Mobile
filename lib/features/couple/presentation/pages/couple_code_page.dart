...
class _CoupleCodePageState extends State<CoupleCodePage> {
  ...
  late final CoupleRemoteDatasource _coupleRemoteDatasource;
  ...
  void initState() {
    ...
    _coupleRemoteDatasource = CoupleRemoteDatasource(dio);
  ...
  Future<void> fetchCoupleCode() async {
    if (!mounted) return;
    ...
    try {
      ...
      // Refresh shell scaffold state to update pending invitations in bell icon
      if (mounted) {
